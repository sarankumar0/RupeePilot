    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center">
      <div className="bg-gray-900 rounded-2xl p-10 flex flex-col items-center gap-6 shadow-xl w-full max-w-sm">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white">💰 RupeePilot</h1>
          <p className="text-gray-400 mt-2 text-sm">Your personal finance assistant</p>
        </div>
        ...
        <p className="text-gray-600 text-xs text-center">
          Track expenses by chatting with your Telegram bot
        </p>
      </div>
    </div>
  );
